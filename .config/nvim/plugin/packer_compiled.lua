...
_G.packer_plugins = {
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/ares/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  ["vim-gutentags"] = {
    loaded = true,
    path = "/home/ares/.local/share/nvim/site/pack/packer/start/vim-gutentags",
    url = "https://github.com/ludovicchabant/vim-gutentags"
  },
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/ares/.local/share/nvim/site/pack/packer/start/vim-vsnip",
